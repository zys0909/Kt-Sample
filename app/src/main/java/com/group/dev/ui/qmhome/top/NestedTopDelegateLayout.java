...
public class NestedTopDelegateLayout extends FrameLayout implements
        NestedScrollingChild2, NestedScrollingParent2, INestedTopView {

    public static final String KEY_SCROLL_INFO_OFFSET = "scroll_info_top_dl_offset";

    private OnScrollNotifier mScrollNotifier;
    private View mHeaderView;
    private INestedTopView mDelegateView;
    ...
    public NestedTopDelegateLayout(@NonNull Context context) {
        this(context, null);
    }

    public NestedTopDelegateLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
    ...
    public void setDelegateView(@NonNull INestedTopView delegateView) {
        ...
        // WRAP_CONTENT, the height will be handled by NestedTopAreaBehavior
    ...
    public INestedTopView getDelegateView() {
    ...
    public void restoreScrollInfo(@NonNull Bundle bundle) {
        ...
        offsetTo(Helper.constrain(-offset, 0, getContainerOffsetRange()));
        if (mDelegateView != null) {
