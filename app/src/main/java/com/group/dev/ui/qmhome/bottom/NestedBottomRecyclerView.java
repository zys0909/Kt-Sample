...
public class NestedBottomRecyclerView extends RecyclerView implements INestedBottomView {
    ...
    public NestedBottomRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public NestedBottomRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
                ...
                if (mOnScrollNotifier != null) {
                    if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                        mOnScrollNotifier.onScrollStateChange(recyclerView,
                                INestedScrollCommon.SCROLL_STATE_IDLE);
                    } else if (newState == RecyclerView.SCROLL_STATE_SETTLING) {
                        mOnScrollNotifier.onScrollStateChange(recyclerView,
                                INestedScrollCommon.SCROLL_STATE_SETTLING);
                    } else if (newState == RecyclerView.SCROLL_STATE_DRAGGING) {
                        mOnScrollNotifier.onScrollStateChange(recyclerView,
                                INestedScrollCommon.SCROLL_STATE_DRAGGING);
                    }
                }
            }
