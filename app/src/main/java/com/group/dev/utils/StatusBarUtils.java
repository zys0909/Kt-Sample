...
import com.group.common.util.OSUtils;
...
public class StatusBarUtils {
    private static int FAKE_STATUS_BAR_VIEW_ID = R.id.fake_status_bar_view;
     ...
     * @param color   状态栏颜色
     */
    public void setColor(Context context, @ColorInt int color) {
    ...
    public static void setColor(Window window, @ColorInt int color, boolean isTransparent) {
     ...
     */
    public void setTextDark(Context context, boolean isDark) {
        if (context instanceof Activity) {
    ...
    public static void setTextDark(Window window, boolean isDark) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (OSUtils.getRomType() == OSUtils.ROM.Flyme) {
