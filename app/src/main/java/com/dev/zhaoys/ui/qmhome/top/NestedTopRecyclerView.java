...
public class NestedTopRecyclerView extends RecyclerView implements INestedTopView {
    ...
    public NestedTopRecyclerView(@NonNull Context context) {
        this(context, null);
        init();
    }

    public NestedTopRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
        init();
    }

    public NestedTopRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
