...
public final class NullAdapters {
    private NullAdapters() {
    }
    ...
    public static final JsonAdapter.Factory FACTORY = new JsonAdapter.Factory() {
        @Override public JsonAdapter<?> create(
            ...
            if (type == Object.class) return new NullAdapters.ObjectJsonAdapter(moshi).nullSafe();
            ...
            if (rawType.isEnum()) {
                ...
                return new NullAdapters.EnumJsonAdapter<>((Class<? extends Enum>) rawType).nullSafe();
            }
            return null;
        }
    };
